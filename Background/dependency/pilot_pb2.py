...
_RESPONSE10019_DATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='searchedUser', full_name='com.xiang.proto.pilot.Response10019.Data.searchedUser', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESPONSE10019_DATA.fields_by_name['searchedUser'].message_type = common__pb2._SEARCHEDUSER
