# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-05-13 09:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('briefGym', models.ManyToManyField(to='Background.BriefGym')),
                ('courses', models.ManyToManyField(to='Background.Course')),
            ],
        ),
        migrations.CreateModel(
            name='Equipment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('briefUser', models.ManyToManyField(to='Background.BriefUser')),
            ],
        ),
        migrations.AddField(
            model_name='detailgym',
            name='equipments',
            field=models.ManyToManyField(to='Background.Equipment'),
        ),
        migrations.AddField(
            model_name='detailgym',
            name='gymCard',
            field=models.ManyToManyField(to='Background.GymCard'),
        ),
        migrations.AddField(
            model_name='course',
            name='courseTime',
            field=models.ManyToManyField(to='Background.CourseTime'),
        ),
    ]
